    ...
    >
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          <DialogTrigger>
            <button className="h-11 px-5 bg-blue-600 text-white rounded-xl font-medium shadow-lg hover:opacity-90 transition-opacity flex items-center gap-2">
          ...
          <DialogContent className="sm:max-w-md rounded-2xl">
            ...
            <DialogFooter>
              ...
              <button
                ...
                className="h-10 px-4 bg-blue-600 text-white rounded-xl hover:opacity-90 transition-opacity"
              >
                Simpan
              </button>
            </DialogFooter>
